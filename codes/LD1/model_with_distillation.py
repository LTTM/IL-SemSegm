...
class model:
    ...
    def training_model(self):
        ...
        if self.is_incremental:
            G_loss, G_new_softmax , G_loss_summary = self.network_loss(G_input=self.network_input,
            ...
            # Define loss functions
            G_loss, _, G_loss_summary = self.network_loss(G_input=G_input, gt_labels=G_labels)
        ...
        return G_loss, distill_loss, final_loss, G_optimizer, training_summary, G_new_softmax
    ...
    def distillation_loss(self, new_softmax, old_softmax, gt_labels, applied_to='all'):
        ...
        It may have some zeros at the end of the tensor
        :param gt_labels: gt with classes. 4D tensor: [batch_size, image_width, image_height, 1]
        :param applied_to: on which class apply the loss : {all, old, old_bgr}
    ...
    def compute_validation_loss(self, G_input, gt_labels):
        ...
        # Compute loss
        loss, output_maps, _ = self.network_loss(G_input=G_input, gt_labels=gt_labels)
