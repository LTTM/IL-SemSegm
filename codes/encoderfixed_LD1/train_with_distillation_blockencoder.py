...
def train():
    ...
    with graph.as_default():
        ...
        G_sup_loss, G_distill_loss, G_final_loss, G_sup_optimizer, training_summary_sup, G_new_softmax = gan.training_model()
    ...
    with tf.Session(graph=graph, config=config) as sess:
        ...
        if FLAGS.is_incremental:
            ...
            if FLAGS.is_save_new_softmax_maps:
                try:
                    new_soft_mat_dir = 'new_softmax_mat_'+str(FLAGS.from_new_class+1)+'_'+str(FLAGS.to_new_class)
        ...
        try:
            while not coord.should_stop() and step < FLAGS.training_steps:
                ...
                if FLAGS.is_incremental:
                    ...
                    _, G_loss_value, summary, new_softmax, G_distill_loss_value, G_final_loss_value  =(sess.run(
                        [G_sup_optimizer, G_sup_loss, training_summary_sup, G_new_softmax, G_distill_loss, G_final_loss],
